...
class RestrictionSetStateParams
private constructor(
    private val id: Long?,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RestrictionSetStateParams].
         *
    ...
    /** A builder for [RestrictionSetStateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(restrictionSetStateParams: RestrictionSetStateParams) = apply {
            id = restrictionSetStateParams.id
            key = restrictionSetStateParams.key
            body = restrictionSetStateParams.body.toBuilder()
            additionalHeaders = restrictionSetStateParams.additionalHeaders.toBuilder()
            additionalQueryParams = restrictionSetStateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RestrictionSetStateParams].
         *
         ...
         */
        fun build(): RestrictionSetStateParams =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && state == other.state && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RestrictionSetStateParams && id == other.id && key == other.key && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(id, key, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "RestrictionSetStateParams{id=$id, key=$key, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
