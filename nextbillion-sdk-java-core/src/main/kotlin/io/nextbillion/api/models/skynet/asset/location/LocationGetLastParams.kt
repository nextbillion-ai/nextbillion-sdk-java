...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LocationGetLastParams].
         *
    ...
    /** A builder for [LocationGetLastParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationGetLastParams: LocationGetLastParams) = apply {
            id = locationGetLastParams.id
            key = locationGetLastParams.key
            cluster = locationGetLastParams.cluster
            additionalHeaders = locationGetLastParams.additionalHeaders.toBuilder()
            additionalQueryParams = locationGetLastParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LocationGetLastParams].
         *
         ...
         */
        fun build(): LocationGetLastParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LocationGetLastParams && id == other.id && key == other.key && cluster == other.cluster && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LocationGetLastParams{id=$id, key=$key, cluster=$cluster, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
