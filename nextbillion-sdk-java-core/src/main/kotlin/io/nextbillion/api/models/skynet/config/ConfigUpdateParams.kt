...
private constructor(
    ...
    /**
     * Use this array to update information about the webhooks. Please note that the webhooks will
     * be overwritten every time this method is used.
     *
     * @throws NextbillionSdkInvalidDataException if the JSON field has an unexpected type (e.g. if
     *   the server responded with an unexpected value).
     */
    fun webhook(): Optional<List<String>> = body.webhook()
     ...
     */
    fun _webhook(): JsonField<List<String>> = body._webhook()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(configUpdateParams: ConfigUpdateParams) = apply {
            key = configUpdateParams.key
            cluster = configUpdateParams.cluster
        ...
        /**
         * Use this array to update information about the webhooks. Please note that the webhooks
         * will be overwritten every time this method is used.
         */
        fun webhook(webhook: List<String>) = apply { body.webhook(webhook) }

        /**
         * Sets [Builder.webhook] to an arbitrary JSON value.
         *
         * You should usually call [Builder.webhook] with a well-typed `List<String>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun webhook(webhook: JsonField<List<String>>) = apply { body.webhook(webhook) }
         ...
         */
        fun addWebhook(webhook: String) = apply { body.addWebhook(webhook) }
    ...
    private constructor(
         ...
         * Unlike [webhook], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("webhook") @ExcludeMissing fun _webhook(): JsonField<List<String>> = webhook
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                webhook = body.webhook.map { it.toMutableList() }
        ...
        override fun toString() =
            "Body{webhook=$webhook, additionalProperties=$additionalProperties}"
    }
