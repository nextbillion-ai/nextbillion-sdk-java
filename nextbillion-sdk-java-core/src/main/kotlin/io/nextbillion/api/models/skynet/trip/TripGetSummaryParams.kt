...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TripGetSummaryParams].
         *
    ...
    /** A builder for [TripGetSummaryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tripGetSummaryParams: TripGetSummaryParams) = apply {
            id = tripGetSummaryParams.id
            key = tripGetSummaryParams.key
            cluster = tripGetSummaryParams.cluster
            additionalHeaders = tripGetSummaryParams.additionalHeaders.toBuilder()
            additionalQueryParams = tripGetSummaryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TripGetSummaryParams].
         *
         ...
         */
        fun build(): TripGetSummaryParams =
