...
private constructor(
    ...
    /**
     * An array of objects returning the details of each document template associated with the
     * specified API key. Each object represents one document template. In case there are no
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DocumentTemplateListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DocumentTemplateListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentTemplateListResponse: DocumentTemplateListResponse) = apply {
            data = documentTemplateListResponse.data.map { it.toMutableList() }
            msg = documentTemplateListResponse.msg
            status = documentTemplateListResponse.status
            additionalProperties = documentTemplateListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DocumentTemplateListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocumentTemplateListResponse =
    ...
    fun validate(): DocumentTemplateListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            content: JsonField<List<DocumentTemplateContentResponse>> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        ) : this(id, content, name, mutableMapOf())
        ...
        /**
         * An array of objects returning the details of data structures and validation rules and
         * other properties of all document fields. Each object represents one document field.
         *
         * @throws NextbillionSdkInvalidDataException if the JSON field has an unexpected type (e.g.
         *   if the server responded with an unexpected value).
         */
        fun content(): Optional<List<DocumentTemplateContentResponse>> =
        ...
        @JsonProperty("content")
        @ExcludeMissing
        fun _content(): JsonField<List<DocumentTemplateContentResponse>> = content
        ...
        class Builder internal constructor() {
            ...
            private var content: JsonField<MutableList<DocumentTemplateContentResponse>>? = null
             ...
             * other properties of all document fields. Each object represents one document field.
             */
            fun content(content: List<DocumentTemplateContentResponse>) =
             ...
             * `List<DocumentTemplateContentResponse>` value instead. This method is primarily for
             * setting the field to an undocumented or not yet supported value.
             */
            fun content(content: JsonField<List<DocumentTemplateContentResponse>>) = apply {
                this.content = content.map { it.toMutableList() }
            }

            /**
             * Adds a single [DocumentTemplateContentResponse] to [Builder.content].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addContent(content: DocumentTemplateContentResponse) = apply {
                this.content =
        ...
        override fun toString() =
            "Data{id=$id, content=$content, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentTemplateListResponse && data == other.data && msg == other.msg && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DocumentTemplateListResponse{data=$data, msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
