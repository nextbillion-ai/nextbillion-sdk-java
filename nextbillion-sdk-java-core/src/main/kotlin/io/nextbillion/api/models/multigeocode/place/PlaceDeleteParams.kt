 ...
 *
 * Use this method to delete a previously created place. Please note that the place associated with
 * the specified docID only would be deleted. As a result, once a place is deleted, the search API
 * can still return valid results from the default datasets or others, if present.
 */
class PlaceDeleteParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlaceDeleteParams].
         *
    ...
    /** A builder for [PlaceDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(placeDeleteParams: PlaceDeleteParams) = apply {
            docId = placeDeleteParams.docId
            key = placeDeleteParams.key
            additionalHeaders = placeDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = placeDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = placeDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlaceDeleteParams].
         *
