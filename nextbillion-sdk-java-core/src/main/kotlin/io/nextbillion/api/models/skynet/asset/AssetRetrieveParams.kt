...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssetRetrieveParams].
         *
    ...
    /** A builder for [AssetRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(assetRetrieveParams: AssetRetrieveParams) = apply {
            id = assetRetrieveParams.id
            key = assetRetrieveParams.key
            cluster = assetRetrieveParams.cluster
            additionalHeaders = assetRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = assetRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AssetRetrieveParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AssetRetrieveParams && id == other.id && key == other.key && cluster == other.cluster && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AssetRetrieveParams{id=$id, key=$key, cluster=$cluster, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
