...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(assetDeleteParams: AssetDeleteParams) = apply {
            id = assetDeleteParams.id
            key = assetDeleteParams.key
            cluster = assetDeleteParams.cluster
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AssetDeleteParams && id == other.id && key == other.key && cluster == other.cluster && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AssetDeleteParams{id=$id, key=$key, cluster=$cluster, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
