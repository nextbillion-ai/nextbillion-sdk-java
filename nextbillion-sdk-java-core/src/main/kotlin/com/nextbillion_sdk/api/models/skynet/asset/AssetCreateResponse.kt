...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AssetCreateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AssetCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(assetCreateResponse: AssetCreateResponse) = apply {
            data = assetCreateResponse.data
            message = assetCreateResponse.message
            status = assetCreateResponse.status
        ...
        /**
         * Returns an immutable instance of [AssetCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AssetCreateResponse =
            AssetCreateResponse(data, message, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): AssetCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AssetCreateResponse && data == other.data && message == other.message && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AssetCreateResponse{data=$data, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
