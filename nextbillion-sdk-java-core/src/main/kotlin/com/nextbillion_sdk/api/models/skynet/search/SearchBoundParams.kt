...
package com.nextbillion_sdk.api.models.skynet.search
...
private constructor(
    ...
    /**
     * Specify two, pipe (|) delimited location coordinates which would act as corners of the
     * bounding box area to be searched. The first one should be the southwest coordinate of the
     * `bounds` and the second one should be the northeast coordinate of the `bounds`.
     */
    fun bound(): String = bound
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SearchBoundParams].
         *
    ...
    /** A builder for [SearchBoundParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(searchBoundParams: SearchBoundParams) = apply {
            bound = searchBoundParams.bound
            key = searchBoundParams.key
            filter = searchBoundParams.filter
            includeAllOfAttributes = searchBoundParams.includeAllOfAttributes
            includeAnyOfAttributes = searchBoundParams.includeAnyOfAttributes
            maxSearchLimit = searchBoundParams.maxSearchLimit
            pn = searchBoundParams.pn
            ps = searchBoundParams.ps
            sortBy = searchBoundParams.sortBy
            sortDestination = searchBoundParams.sortDestination
            sortDrivingMode = searchBoundParams.sortDrivingMode
            additionalHeaders = searchBoundParams.additionalHeaders.toBuilder()
            additionalQueryParams = searchBoundParams.additionalQueryParams.toBuilder()
        }
         ...
         * `bounds` and the second one should be the northeast coordinate of the `bounds`.
         */
        fun bound(bound: String) = apply { this.bound = bound }
        ...
        /**
         * Returns an immutable instance of [SearchBoundParams].
         *
         ...
         */
        fun build(): SearchBoundParams =
            SearchBoundParams(
                checkRequired("bound", bound),
