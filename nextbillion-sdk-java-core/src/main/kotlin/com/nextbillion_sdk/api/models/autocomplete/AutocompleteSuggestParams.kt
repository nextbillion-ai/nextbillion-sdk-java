...
package com.nextbillion_sdk.api.models.autocomplete
...
/** Autocomplete */
class AutocompleteSuggestParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutocompleteSuggestParams].
         *
    ...
    /** A builder for [AutocompleteSuggestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autocompleteSuggestParams: AutocompleteSuggestParams) = apply {
            key = autocompleteSuggestParams.key
            q = autocompleteSuggestParams.q
            at = autocompleteSuggestParams.at
            in_ = autocompleteSuggestParams.in_
            lang = autocompleteSuggestParams.lang
            limit = autocompleteSuggestParams.limit
            additionalHeaders = autocompleteSuggestParams.additionalHeaders.toBuilder()
            additionalQueryParams = autocompleteSuggestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteSuggestParams].
         *
         ...
         */
        fun build(): AutocompleteSuggestParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AutocompleteSuggestParams && key == other.key && q == other.q && at == other.at && in_ == other.in_ && lang == other.lang && limit == other.limit && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AutocompleteSuggestParams{key=$key, q=$q, at=$at, in_=$in_, lang=$lang, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
