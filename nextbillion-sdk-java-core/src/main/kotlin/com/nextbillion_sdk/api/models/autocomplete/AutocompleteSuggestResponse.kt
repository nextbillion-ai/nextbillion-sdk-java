...
class AutocompleteSuggestResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutocompleteSuggestResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AutocompleteSuggestResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autocompleteSuggestResponse: AutocompleteSuggestResponse) = apply {
            items = autocompleteSuggestResponse.items.map { it.toMutableList() }
            additionalProperties = autocompleteSuggestResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteSuggestResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AutocompleteSuggestResponse =
    ...
    fun validate(): AutocompleteSuggestResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AutocompleteSuggestResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AutocompleteSuggestResponse{items=$items, additionalProperties=$additionalProperties}"
}
