...
package com.nextbillion_sdk.api.models.autosuggest
...
/** Autosuggest */
class AutosuggestSuggestParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutosuggestSuggestParams].
         *
    ...
    /** A builder for [AutosuggestSuggestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autosuggestSuggestParams: AutosuggestSuggestParams) = apply {
            key = autosuggestSuggestParams.key
            q = autosuggestSuggestParams.q
            at = autosuggestSuggestParams.at
            in_ = autosuggestSuggestParams.in_
            lang = autosuggestSuggestParams.lang
            limit = autosuggestSuggestParams.limit
            additionalHeaders = autosuggestSuggestParams.additionalHeaders.toBuilder()
            additionalQueryParams = autosuggestSuggestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AutosuggestSuggestParams].
         *
         ...
         */
        fun build(): AutosuggestSuggestParams =
            AutosuggestSuggestParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AutosuggestSuggestParams && key == other.key && q == other.q && at == other.at && in_ == other.in_ && lang == other.lang && limit == other.limit && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AutosuggestSuggestParams{key=$key, q=$q, at=$at, in_=$in_, lang=$lang, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
