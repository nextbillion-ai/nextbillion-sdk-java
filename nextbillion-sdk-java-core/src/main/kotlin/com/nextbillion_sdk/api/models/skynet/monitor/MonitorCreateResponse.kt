...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(monitorCreateResponse: MonitorCreateResponse) = apply {
            ...
            message = monitorCreateResponse.message
            status = monitorCreateResponse.status
        ...
        fun build(): MonitorCreateResponse =
            MonitorCreateResponse(data, message, status, additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MonitorCreateResponse && data == other.data && message == other.message && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MonitorCreateResponse{data=$data, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
