...
class AutosuggestSuggestResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutosuggestSuggestResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AutosuggestSuggestResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autosuggestSuggestResponse: AutosuggestSuggestResponse) = apply {
            items = autosuggestSuggestResponse.items.map { it.toMutableList() }
            additionalProperties = autosuggestSuggestResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutosuggestSuggestResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AutosuggestSuggestResponse =
    ...
    fun validate(): AutosuggestSuggestResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AutosuggestSuggestResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AutosuggestSuggestResponse{items=$items, additionalProperties=$additionalProperties}"
}
