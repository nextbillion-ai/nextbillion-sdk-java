...
private constructor(
    ...
    /** A builder for [DocumentTemplateCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentTemplateCreateResponse: DocumentTemplateCreateResponse) = apply {
            data = documentTemplateCreateResponse.data
            msg = documentTemplateCreateResponse.msg
            status = documentTemplateCreateResponse.status
            additionalProperties =
                documentTemplateCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DocumentTemplateCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocumentTemplateCreateResponse =
            DocumentTemplateCreateResponse(data, msg, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): DocumentTemplateCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentTemplateCreateResponse && data == other.data && msg == other.msg && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DocumentTemplateCreateResponse{data=$data, msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
