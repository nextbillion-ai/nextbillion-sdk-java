...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowseSearchResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowseSearchResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browseSearchResponse: BrowseSearchResponse) = apply {
            items = browseSearchResponse.items.map { it.toMutableList() }
            additionalProperties = browseSearchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowseSearchResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowseSearchResponse =
    ...
    fun validate(): BrowseSearchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BrowseSearchResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BrowseSearchResponse{items=$items, additionalProperties=$additionalProperties}"
}
