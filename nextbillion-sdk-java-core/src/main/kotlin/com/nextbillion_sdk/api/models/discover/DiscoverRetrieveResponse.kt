...
class DiscoverRetrieveResponse
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DiscoverRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DiscoverRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(discoverRetrieveResponse: DiscoverRetrieveResponse) = apply {
            items = discoverRetrieveResponse.items.map { it.toMutableList() }
            additionalProperties = discoverRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DiscoverRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DiscoverRetrieveResponse =
    ...
    fun validate(): DiscoverRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DiscoverRetrieveResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DiscoverRetrieveResponse{items=$items, additionalProperties=$additionalProperties}"
}
