...
private constructor(
    ...
    /**
     * This could be “Ok” representing success or “not found” representing error in processing the
     * request.
     *
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PlaceUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlaceUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(placeUpdateResponse: PlaceUpdateResponse) = apply {
            msg = placeUpdateResponse.msg
            status = placeUpdateResponse.status
            additionalProperties = placeUpdateResponse.additionalProperties.toMutableMap()
        }

        /**
         * This could be “Ok” representing success or “not found” representing error in processing
         * the request.
         */
        ...
        /**
         * Returns an immutable instance of [PlaceUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlaceUpdateResponse =
            PlaceUpdateResponse(msg, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PlaceUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlaceUpdateResponse && msg == other.msg && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PlaceUpdateResponse{msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
