...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tripRetrieveParams: TripRetrieveParams) = apply {
            id = tripRetrieveParams.id
            key = tripRetrieveParams.key
            cluster = tripRetrieveParams.cluster
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TripRetrieveParams && id == other.id && key == other.key && cluster == other.cluster && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TripRetrieveParams{id=$id, key=$key, cluster=$cluster, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
