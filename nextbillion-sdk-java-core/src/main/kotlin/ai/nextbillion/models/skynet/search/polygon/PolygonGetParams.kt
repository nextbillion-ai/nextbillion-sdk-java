...
/** Polygon Search */
class PolygonGetParams
private constructor(
    private val key: String,
    private val polygon: String,
    ...
    /**
     * Define a custom polygon enclosing the area to be searched. It should be a pipe (|) delimited
     * list of location coordinates.
     *
     * Please ensure that the polygon provided is enclosed. This can be achieved by making the last
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PolygonGetParams].
         *
    ...
    /** A builder for [PolygonGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(polygonGetParams: PolygonGetParams) = apply {
            key = polygonGetParams.key
            polygon = polygonGetParams.polygon
            filter = polygonGetParams.filter
            includeAllOfAttributes = polygonGetParams.includeAllOfAttributes
            includeAnyOfAttributes = polygonGetParams.includeAnyOfAttributes
            maxSearchLimit = polygonGetParams.maxSearchLimit
            pn = polygonGetParams.pn
            ps = polygonGetParams.ps
            sortBy = polygonGetParams.sortBy
            sortDestination = polygonGetParams.sortDestination
            sortDrivingMode = polygonGetParams.sortDrivingMode
            additionalHeaders = polygonGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = polygonGetParams.additionalQueryParams.toBuilder()
        }
         ...
         *
         * Please ensure that the polygon provided is enclosed. This can be achieved by making the
         * last location coordinate in the list equal to the first location coordinate of the list.
         *
         * Please note that the maximum area of the search polygon allowed is 3000 km<sup>2</sup>.
         */
        fun polygon(polygon: String) = apply { this.polygon = polygon }
        ...
        /**
         * Returns an immutable instance of [PolygonGetParams].
         *
