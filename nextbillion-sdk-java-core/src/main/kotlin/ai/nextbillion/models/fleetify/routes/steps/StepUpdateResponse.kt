...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StepUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StepUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stepUpdateResponse: StepUpdateResponse) = apply {
            data = stepUpdateResponse.data
            message = stepUpdateResponse.message
            status = stepUpdateResponse.status
            additionalProperties = stepUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StepUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StepUpdateResponse =
            StepUpdateResponse(data, message, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): StepUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StepUpdateResponse && data == other.data && message == other.message && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "StepUpdateResponse{data=$data, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
