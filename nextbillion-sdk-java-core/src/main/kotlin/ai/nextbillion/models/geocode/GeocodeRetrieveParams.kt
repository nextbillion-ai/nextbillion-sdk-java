...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GeocodeRetrieveParams].
         *
    ...
    /** A builder for [GeocodeRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geocodeRetrieveParams: GeocodeRetrieveParams) = apply {
            key = geocodeRetrieveParams.key
            q = geocodeRetrieveParams.q
            at = geocodeRetrieveParams.at
            in_ = geocodeRetrieveParams.in_
            lang = geocodeRetrieveParams.lang
            limit = geocodeRetrieveParams.limit
            additionalHeaders = geocodeRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = geocodeRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GeocodeRetrieveParams].
         *
         ...
         */
        fun build(): GeocodeRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GeocodeRetrieveParams && key == other.key && q == other.q && at == other.at && in_ == other.in_ && lang == other.lang && limit == other.limit && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GeocodeRetrieveParams{key=$key, q=$q, at=$at, in_=$in_, lang=$lang, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
