...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TripEndParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tripEndParams: TripEndParams) = apply {
            key = tripEndParams.key
            cluster = tripEndParams.cluster
            body = tripEndParams.body.toBuilder()
            additionalHeaders = tripEndParams.additionalHeaders.toBuilder()
            additionalQueryParams = tripEndParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TripEndParams].
         *
