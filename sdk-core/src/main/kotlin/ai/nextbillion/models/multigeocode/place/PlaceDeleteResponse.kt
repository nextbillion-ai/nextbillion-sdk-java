...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PlaceDeleteResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlaceDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(placeDeleteResponse: PlaceDeleteResponse) = apply {
            msg = placeDeleteResponse.msg
            status = placeDeleteResponse.status
            additionalProperties = placeDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlaceDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlaceDeleteResponse =
            PlaceDeleteResponse(msg, status, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): PlaceDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PlaceDeleteResponse{msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
