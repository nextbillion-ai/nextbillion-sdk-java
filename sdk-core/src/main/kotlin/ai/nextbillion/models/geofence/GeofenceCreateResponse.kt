...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GeofenceCreateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GeofenceCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geofenceCreateResponse: GeofenceCreateResponse) = apply {
            data = geofenceCreateResponse.data
            status = geofenceCreateResponse.status
            additionalProperties = geofenceCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GeofenceCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeofenceCreateResponse =
            GeofenceCreateResponse(data, status, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): GeofenceCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "GeofenceCreateResponse{data=$data, status=$status, additionalProperties=$additionalProperties}"
}
