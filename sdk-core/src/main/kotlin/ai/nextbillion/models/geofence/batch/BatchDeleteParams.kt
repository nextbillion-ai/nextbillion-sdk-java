...
private constructor(
    ...
    /**
     * An array IDs of the geofence to be deleted. These are the IDs that were generated/provided at
     * the time of creating the respective geofences.
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchDeleteParams: BatchDeleteParams) = apply {
            key = batchDeleteParams.key
            body = batchDeleteParams.body.toBuilder()
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && ids == other.ids && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchDeleteParams && key == other.key && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(key, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "BatchDeleteParams{key=$key, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
