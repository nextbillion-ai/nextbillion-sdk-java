        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("value")
                    @ExcludeMissing
                    value: JsonField<ObjectiveValue> = JsonMissing.of(),
                 ...
                 *   unexpected value).
                 */
                fun value(): ObjectiveValue = value.getRequired("value")
                ...
                @JsonProperty("value")
                @ExcludeMissing
                fun _value(): JsonField<ObjectiveValue> = value
                ...
                class Builder internal constructor() {
                    ...
                    private var value: JsonField<ObjectiveValue>? = null
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                     ...
                     */
                    fun value(value: ObjectiveValue) = value(JsonField.of(value))

                    /**
                     * Sets [Builder.value] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.value] with a well-typed [ObjectiveValue]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun value(value: JsonField<ObjectiveValue>) = apply { this.value = value }
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmStatic fun of(value: String) = ObjectiveValue(JsonField.of(value))
                    }

                    /** An enum containing [ObjectiveValue]'s known values. */
                    enum class Known {
                        VEHICLES,
                        COMPLETION_TIME,
                        TRAVEL_COST,
                    ...
                    /**
                     * An enum containing [ObjectiveValue]'s known values, as well as an [_UNKNOWN]
                     * member.
                     *
                     * An instance of [ObjectiveValue] can contain an unknown value in a couple of
                     * cases:
                     * - It was deserialized from data that doesn't match any known member. For
                     *   example, if the SDK is on an older version than the API, then the API may
                     *   respond with new members that the SDK is unaware of.
                    ...
                    enum class Value {
                        ...
                        TASKS,
                        /**
                         * An enum member indicating that [ObjectiveValue] was instantiated with an
                         * unknown value.
                         */
                        _UNKNOWN,
                    }
                     ...
                     *   doesn't match its expected type.
                     */
                    fun validate(): ObjectiveValue = apply {
                        if (validated) {
                            return@apply
                        }
