...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RouteStepsRequest].
         *
    ...
    /** A builder for [RouteStepsRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStepsRequest: RouteStepsRequest) = apply {
            arrival = routeStepsRequest.arrival
            location = routeStepsRequest.location.map { it.toMutableList() }
            type = routeStepsRequest.type
            address = routeStepsRequest.address
            completionMode = routeStepsRequest.completionMode
            documentTemplateId = routeStepsRequest.documentTemplateId
            duration = routeStepsRequest.duration
            geofenceConfig = routeStepsRequest.geofenceConfig
            meta = routeStepsRequest.meta
            additionalProperties = routeStepsRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RouteStepsRequest].
         *
     ...
     *   expected type.
     */
    fun validate(): RouteStepsRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "RouteStepsRequest{arrival=$arrival, location=$location, type=$type, address=$address, completionMode=$completionMode, documentTemplateId=$documentTemplateId, duration=$duration, geofenceConfig=$geofenceConfig, meta=$meta, additionalProperties=$additionalProperties}"
}
