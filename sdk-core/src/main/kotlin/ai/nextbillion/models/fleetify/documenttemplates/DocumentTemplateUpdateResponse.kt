...
private constructor(
    ...
    /** A builder for [DocumentTemplateUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentTemplateUpdateResponse: DocumentTemplateUpdateResponse) = apply {
            data = documentTemplateUpdateResponse.data
            msg = documentTemplateUpdateResponse.msg
            status = documentTemplateUpdateResponse.status
            additionalProperties =
                documentTemplateUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DocumentTemplateUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocumentTemplateUpdateResponse =
            DocumentTemplateUpdateResponse(data, msg, status, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): DocumentTemplateUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * An array of object returning the details of updated data structures and validation rules
         * for document fields. Each object represents one document field.
         *
         * @throws NextbillionSdkInvalidDataException if the JSON field has an unexpected type (e.g.
         *   if the server responded with an unexpected value).
         */
        ...
        class Builder internal constructor() {
            ...
            /**
             * An array of object returning the details of updated data structures and validation
             * rules for document fields. Each object represents one document field.
             */
    ...
    override fun toString() =
        "DocumentTemplateUpdateResponse{data=$data, msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
