...
private constructor(
    ...
    /** A builder for [GeocodeStructuredRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geocodeStructuredRetrieveResponse: GeocodeStructuredRetrieveResponse) =
            apply {
                items = geocodeStructuredRetrieveResponse.items.map { it.toMutableList() }
                additionalProperties =
                    geocodeStructuredRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GeocodeStructuredRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeocodeStructuredRetrieveResponse =
            GeocodeStructuredRetrieveResponse(
     ...
     *   expected type.
     */
    fun validate(): GeocodeStructuredRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GeocodeStructuredRetrieveResponse &&
            items == other.items &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "GeocodeStructuredRetrieveResponse{items=$items, additionalProperties=$additionalProperties}"
}
