...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GeocodeRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GeocodeRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geocodeRetrieveResponse: GeocodeRetrieveResponse) = apply {
            items = geocodeRetrieveResponse.items.map { it.toMutableList() }
            additionalProperties = geocodeRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GeocodeRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeocodeRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): GeocodeRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "GeocodeRetrieveResponse{items=$items, additionalProperties=$additionalProperties}"
}
