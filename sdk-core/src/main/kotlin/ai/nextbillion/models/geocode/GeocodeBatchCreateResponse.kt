...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GeocodeBatchCreateResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GeocodeBatchCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geocodeBatchCreateResponse: GeocodeBatchCreateResponse) = apply {
            items = geocodeBatchCreateResponse.items.map { it.toMutableList() }
            additionalProperties = geocodeBatchCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GeocodeBatchCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeocodeBatchCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): GeocodeBatchCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Item{id=$id, access=$access, address=$address, categories=$categories, contacts=$contacts, distance=$distance, mapView=$mapView, position=$position, scoring=$scoring, title=$title, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "GeocodeBatchCreateResponse{items=$items, additionalProperties=$additionalProperties}"
}
