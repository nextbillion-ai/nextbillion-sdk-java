...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class ai.nextbillion.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class ai.nextbillion.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class ai.nextbillion.** {
    <init>(...);
