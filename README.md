...
[![Maven Central](https://img.shields.io/maven-central/v/com.nextbillion_sdk.api/nextbillion-sdk-java)](https://central.sonatype.com/artifact/com.nextbillion_sdk.api/nextbillion-sdk-java/0.1.0-alpha.1)
[![javadoc](https://javadoc.io/badge2/com.nextbillion_sdk.api/nextbillion-sdk-java/0.1.0-alpha.1/javadoc.svg)](https://javadoc.io/doc/com.nextbillion_sdk.api/nextbillion-sdk-java/0.1.0-alpha.1)
...
The REST API documentation can be found on [docs.nextbillion.ai](https://docs.nextbillion.ai). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.nextbillion_sdk.api/nextbillion-sdk-java/0.1.0-alpha.1).
...
```kotlin
implementation("com.nextbillion_sdk.api:nextbillion-sdk-java:0.1.0-alpha.1")
```
