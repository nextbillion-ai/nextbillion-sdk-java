...
dependencies {
    testImplementation(project(":nextbillion-sdk-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../nextbillion-sdk-java-core/src/main/resources/META-INF/proguard/nextbillion-sdk-java-core.pro")
}
