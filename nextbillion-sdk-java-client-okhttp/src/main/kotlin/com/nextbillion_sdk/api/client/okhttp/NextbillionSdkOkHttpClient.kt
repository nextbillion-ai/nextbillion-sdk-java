...
import com.nextbillion_sdk.api.client.NextbillionSdkClientImpl
...
/**
 * A class that allows building an instance of [NextbillionSdkClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class NextbillionSdkOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [NextbillionSdkClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): NextbillionSdkClient = builder().fromEnv().build()
    }

    /** A builder for [NextbillionSdkOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NextbillionSdkClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NextbillionSdkClient =
            NextbillionSdkClientImpl(
                clientOptions
                    .httpClient(
