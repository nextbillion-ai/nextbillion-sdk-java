...
package io.nextbillion.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import io.nextbillion.api.client.NextbillionSdkClientAsync
import io.nextbillion.api.client.NextbillionSdkClientAsyncImpl
import io.nextbillion.api.core.ClientOptions
import io.nextbillion.api.core.Timeout
import io.nextbillion.api.core.http.Headers
import io.nextbillion.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [NextbillionSdkClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class NextbillionSdkOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [NextbillionSdkClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): NextbillionSdkClientAsync = builder().fromEnv().build()
    }

    /** A builder for [NextbillionSdkOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [io.nextbillion.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://api.nextbillion.io`.
         */
        ...
        /**
         * Returns an immutable instance of [NextbillionSdkClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NextbillionSdkClientAsync =
            NextbillionSdkClientAsyncImpl(
                clientOptions
                    .httpClient(
